...
public class UniformPants extends DyableAccessory {
    ...
    public Supplier<LayerDefinition> createLayer() {
        return AtelierRenderHelper.createLayer(32, partdefinition -> {
		    ...
		    .addOrReplaceChild("pants_r1", CubeListBuilder.create().texOffs(0, 26).addBox(-4.0F, 3.0F, -2.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.32F)), PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
