...
public class NightVisionBinoculars extends NightVisionDevice {
    ...
    public Supplier<LayerDefinition> createLayer() {
        return AtelierRenderHelper.createLayer(64, partdefinition -> {
            ...
            head.addOrReplaceChild("nvb_down_3_r1", CubeListBuilder.create().texOffs(16, 28).mirror().addBox(1.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F).mirror(false)
            .texOffs(16, 28).addBox(-3.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F)
            .texOffs(0, 28).addBox(-3.0F, -2.7F, -4.0F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, -5.0F, -5.5F, 1.5708F, 0.0F, 0.0F));
            head.addOrReplaceChild("nvd_down_4_r1", CubeListBuilder.create().texOffs(0, 23).addBox(-3.0F, -2.7F, -5.0F, 6.0F, 3.0F, 2.0F, new CubeDeformation(0.1F))
            .texOffs(16, 23).addBox(-3.0F, -4.7F, -5.0F, 2.0F, 2.0F, 2.0F)
            .texOffs(16, 23).mirror().addBox(1.0F, -4.7F, -5.0F, 2.0F, 2.0F, 2.0F).mirror(false)
            .texOffs(16, 18).mirror().addBox(1.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F).mirror(false)
            .texOffs(16, 18).addBox(-3.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F)
            ...
            head.addOrReplaceChild("nvb_up_r1", CubeListBuilder.create().texOffs(32, 0).addBox(-3.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F)
            .texOffs(32, 0).mirror().addBox(1.0F, -4.7F, -4.0F, 2.0F, 2.0F, 2.0F).mirror(false)
