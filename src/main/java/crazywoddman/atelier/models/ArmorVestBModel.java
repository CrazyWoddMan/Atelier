...
public class ArmorVestBModel<T extends LivingEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
		ResourceLocation.fromNamespaceAndPath(Atelier.MODID, "armor_vest_b"),
		"main"
	);
	...
	public ArmorVestBModel(ModelPart root) {
