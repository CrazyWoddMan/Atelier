...
public class PouchModel<T extends LivingEntity> extends EntityModel<T> {
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
		ResourceLocation.fromNamespaceAndPath(Atelier.MODID, "pouch"),
		"main"
	);
	public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(Atelier.MODID, "textures/models/wearable/pouch.png");
	public static final ResourceLocation OVERLAY = ResourceLocation.fromNamespaceAndPath(Atelier.MODID, "textures/models/wearable/pouch_overlay.png");
	...
	public static LayerDefinition createLayer() {
		...
		.addOrReplaceChild("pouch_r1", CubeListBuilder.create().texOffs(0, 5).addBox(-0.5F, -0.8F, -0.8F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.01F)), PartPose.offsetAndRotation(-3.0F, 10.0F, -3.0F, -0.3054F, 0.0F, 0.0F));
